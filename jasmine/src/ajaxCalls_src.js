...
var reposResponse= JSON.parse(RepoResponses.search.success.responseText)  
...
function requestData() {
    ...
    var user_url = textReturn.url
    var repos_url = textReturn.repos_url
...
function responseRepo() {
    if (repoCall.readyState == 4 && repoCall.status == 200) {
        let jsonResponse = reposResponse
        console.log(jsonResponse)
